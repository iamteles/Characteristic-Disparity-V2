...
class PhotoSubState extends MusicBeatSubState
{
	...
	override function update(elapsed:Float)
	{
        ...
        if(Controls.pressed("RESET_SPECIAL")) {
        ...
        if(Controls.pressed("L_SPECIAL") && FlxG.camera.zoom > 0.05) FlxG.camera.zoom -= zoomSpeed;
        if(Controls.pressed("R_SPECIAL") && FlxG.camera.zoom < 2.5) FlxG.camera.zoom += zoomSpeed;
