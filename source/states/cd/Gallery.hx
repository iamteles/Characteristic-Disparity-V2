...
class Gallery extends MusicBeatState
{
    ...
    var items:Map<String, Array<Array<String>>> = [
		...
		"concepts" => [
			...
			["menu/gallery/official/v2_late22-early23/" + "single_fish", "master chef", "v2 (Early)"],
			["menu/gallery/official/v2_late22-early23/" + "smoke_blank_everyday", "smoke WHAT?", "v2 (Early)"],
			["menu/gallery/official/v2_late22-early23/" + "style-swap", "Style Swap", "v2 (Early)"],
			["menu/gallery/official/v2_late22-early23/" + "xmas", "A Shatterdisk Christmas", "v2 (Early)"],
			["menu/gallery/official/v2_late22-early23/" + "watts_first_design", "Watts First Design", "v2 (Early)"],
			["menu/gallery/official/v2_late22-early23/" + "bxb_final", "Early Redesigns", "v2 (Early)"],
			...
			["menu/gallery/official/v2_23/" + "helica_ft_abi", "Helica (Ft. Abi)", "v2"],
			...
			["menu/gallery/official/v2_23/" + "second_redesigns", "Second Redesign", "v2"],
			...
			["menu/gallery/official/v2_23/" + "gamejolt", "Scrapped Login Screen", "v2"],
