...
class Bios extends MusicBeatState
{
    var songs:Array<Array<Dynamic>> = [
        ...
        ["nila", "Nila Robinson", "11", "Female", "4'9", "The silly little scientist supreme. Nila is often babysat by Watts, whom she likes to call “Mom 2”. They've grown a deep inseparable bond over the last couple of years, and love doing experiments and engineering together. She's got a hyperactive attitude which, while meshing well with Bella, clashes a bit with Bex, leading her to prefer Bella's company."],
